...
public class TOrderController {
	...
	public List<TOrderEntity> select(@RequestBody TOrderEntity entity) {
	...
	public PageData<TOrderEntity> likeSelect(@RequestBody TOrderEntity entity) {
	...
	public void update(@RequestBody TOrderEntity entity) {
	...
	public void add(@RequestBody TOrderEntity entity) {
		service.add(entity);
	}
	...
	public void delete(@RequestBody TOrderEntity entity) {
