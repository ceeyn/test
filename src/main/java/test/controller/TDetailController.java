...
public class TDetailController {
	...
	private final TDetailService service;

	@Autowired
	public TDetailController(TDetailService service) {
	...
	public List<TDetailEntity> select(@RequestBody TDetailEntity entity) {
	...
	public PageData<TDetailEntity> likeSelect(@RequestBody TDetailEntity entity) {
	...
	public void update(@RequestBody TDetailEntity entity) {
	...
	public void add(@RequestBody TDetailEntity entity) {
		service.add(entity);
	}
	...
	public void delete(@RequestBody TDetailEntity entity) {
